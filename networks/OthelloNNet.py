...
class OthelloNNet(nn.Module):
    def __init__(self, args):
        ...
        self.fc1 = nn.Linear(self.board_x * self.board_y, 2048)
    ...
    def forward(self, s):
        ...
        s = F.dropout(F.relu(self.fc_bn5(self.fc5(s))), p=self.args.dropout, training=self.training)  # batch_size x 256
